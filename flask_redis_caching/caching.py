...
class RedisCaching:
    ...
    def __init__(self, app=None, config_prefix: str = 'CACHING_REDIS_URL', log: bool = True, pre_ping: bool = True):
    ...
    def init_app(self, app):
        self._redis_client = FlaskRedis(app, config_prefix=self.config_prefix)
